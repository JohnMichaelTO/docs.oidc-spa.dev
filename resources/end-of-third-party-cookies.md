...
However, if your app is **allowed** to set third-party cookies on your authentication server, you may experience a **slight improvement** in the initial load time of your app (because we'll be able to implement silent sign-in in an iframe).
