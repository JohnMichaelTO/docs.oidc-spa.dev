...
For example, if you're using Keycloak and you want an auto disconnect after 5 minutes of inactivity you would set the SSO Session Idle to 5 minutes. See [Keycloak configuration guide](resources/keycloak-configuration.md).
